                ...
                <div class="card shadow-2-strong vh-80 p-5 form-container" style="border-radius: 1rem;">
                    ...
                    <div class="card-body pt-5 pl-5 pr-5 text-center">
                        ...
                        <form class="formulario" action="login.php" method="post">
                            ...
                            <div class="campo">
                                <input class="form-control form-control-lg" type="email" placeholder="Tu Email"
                                    name="email">
                            </div>
                            <!-- label e input de la contraseña !-->
                            <div class="campo">
                                <input class="form-control form-control-lg input__pass" type="password"
                                    placeholder="***********" id="password" name="password">
                                <!-- boton que permite al usuario ver o no ver la contraseña -->
                                <button type="button" class="input__showpass" id="togglePassword"><img
                                        src="img/ojo-on.png" style="width:100%;" /></button>
                            </div>
                            <!-- division -->
                            <hr>
